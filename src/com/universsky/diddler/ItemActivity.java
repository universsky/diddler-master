...
/**
 * @author 东海陈光剑 2014年1月21日 下午5:34:27
 */
public class ItemActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Open Declaration void android.widget.TextView.setText(CharSequence
		// text)
		...
		if (m1.find()) {
			...
			path = path.substring(path.indexOf("GET") + 4,
					path.indexOf("HTTP/1.1") - 1);
		}
